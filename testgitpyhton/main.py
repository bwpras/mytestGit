#A madlib generator template for begineer
...
Label(root, text= 'Mad Libs Generator \n This Is Where the Fun Begins!', font = 'arial 20 bold').pack()
Label(root, text = 'Click Any One :', font = 'arial 15 bold').place(x=60, y=80)
...
def madlib1():
    ...
    things = input('enter name of something: ')
    name = input('enter a name: ')
    place = input('enter a place name: ')
    verb = input('enter a verb in ing form: ')
    food = input('food name: ')
    print('say ' + food + ', the photographer said as the camera flashed! ' + name + ' and '
        'I had gone to ' + place +' to get our photos taken on my birthday. '
        'The first photo we really wanted was a picture of us dressed as ' + animals + ' pretending '
        'to be a ' + profession + '. when we saw the second photo, it was exactly what I wanted. We both looked like ' +
...
def madlib2():
    ...
    print('Last night I dreamed I was a ' +adjactive+ ' butterfly with ' + color+ ' splocthes that looked like '+thing+
...
def madlib3():
    ...
    print('Today we picked apple from ' + person + "'s Orchard. I had no idea there were so many different varieties of apples. I ate " +
          ...
          ' and back. It ended at a hay pile where we got to ' + verb + ' ' + adverb + '. I can hardly wait to get home and cook with the apples. We are going to make appple ' +
